  ...
  return (
    <>
      <motion.div
        ...
        className="card-herbal group overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 h-full flex flex-col"
      >
        {/* Image Carousel */}
        <div className="relative aspect-square overflow-hidden bg-secondary/50">
          ...
          <div className="absolute top-3 left-3">
            <span className="px-3 py-1 bg-white text-black text-xs font-medium rounded-full uppercase">
